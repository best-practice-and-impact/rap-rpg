...
Choices that help them work together effectively will boost their process and code quality. But, choices that make
it harder to collaborate will make it more likely there will be a delay or an error.
