...
from rap_rpg.events.testing_event import Testing
from rap_rpg.events.scrum_master_event import Agile
from rap_rpg.events.research_event import Research
...
if __name__ == "__main__":
    events_list = [Agile, Research, Review, Testing, NewAIAgent]
